...
import { GanttChartSquare, Youtube, Facebook, Twitter, Instagram, Linkedin } from 'lucide-react'; // Placeholder for app store icons

const AppleStoreIcon = () => ( // Simple placeholder SVG
...
const GooglePlayIcon = () => ( // Simple placeholder SVG
  <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="container mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 mb-10">
          ...
          <div className="col-span-2 md:col-span-4 lg:col-span-2 pr-8">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed max-w-xs">
              The ultimate project management software to help your team stay organized and productive.
            </p>
            <div className="mt-6 flex space-x-2">
              <Button variant="outline" className="flex items-center gap-2 text-sm h-auto py-2 px-3 border-input-border hover:border-primary">
                <AppleStoreIcon />
                <div>
               ...
               <Button variant="outline" className="flex items-center gap-2 text-sm h-auto py-2 px-3 border-input-border hover:border-primary">
                <GooglePlayIcon />
                 <div>
                  ...
                  <span className="block font-semibold text-foreground">Google Play</span>
                </div>
              </Button>
            </div>
          </div>
        ...
        <div className="border-t border-border/70 pt-8 flex flex-col sm:flex-row justify-between items-center">
          <p className="text-sm text-muted-foreground">
            &copy; {currentYear} Craft Inc. All rights reserved.
          </p>
